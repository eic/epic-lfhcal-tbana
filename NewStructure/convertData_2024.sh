...
elif [ $1 = "fbockExt3" ]; then 
	dataDir=/media/fbock/T71/CAEN_Sept24_TB_PS
	dataRaw=/media/fbock/T71/202408_PST09/CAENData
elif [ $1 = "eglimos" ]; then 
...
#   runs='492 505'
  for runNr in $runs; do 
    build/Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/MuonRuns/raw_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
...
#   runs='492 505'
  for runNr in $runs; do 
    build/Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/MuonRuns/rawRedStack_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN_reduced.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
...
#   runs='271 277 244 250 282 283 460 456 457 454 526 527 528 554 559 552' 
  ...
  for runNr in $runs; do 
    build/Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/ElectronRuns/raw_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
  ...
  for runNr in $runs; do 
    build/Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/HadronRuns/raw_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
...
#   runs='434' 
  ...
  for runNr in $runs; do 
    build/Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/raw_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
