...
#   runs='492 505'
  for runNr in $runs; do 
    ./Convert -c $dataDir/Run$runNr\_list.txt -o $dataRaw/MuonRuns/rawRedStack_$runNr.root -d 1 -f -m ../configs/mappingFile_202409_CAEN_reduced.txt -r ../configs/DataTakingDB_202409_CAEN.csv
  done;
