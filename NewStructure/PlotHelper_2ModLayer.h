...
#define PLOTTHELPER_2MODLAYER_H
  ...
  void PlotNoiseWithFits2ModLayer (TCanvas* canvas, TPad* pads[16], 
                                 ...
                                 Double_t xPMin, Double_t xPMax, Double_t scaleYMax, int layer, TString nameOutput, RunInfo currRunInfo){
  ...
  void PlotCorrWithFits2ModLayer (TCanvas* canvas, TPad* pads[16], Double_t* topRCornerX,  Double_t* topRCornerY, Double_t* relSize8P, Int_t textSizePixel, 
                                  std::map<int,TileSpectra> spectra, int option, 
                                  Double_t xPMin, Double_t xPMax, Double_t maxY, int layer, TString nameOutput, RunInfo currRunInfo){
  ...
  void PlotCorr2D2ModLayer (TCanvas* canvas, TPad* pads[16], 
                          Double_t* topRCornerX,  Double_t* topRCornerY, Double_t* relSize8P, Int_t textSizePixel, 
                          std::map<int,TileSpectra> spectra, int option,
                          Double_t xPMin, Double_t xPMax, Double_t maxY, int layer, TString nameOutput, RunInfo currRunInfo, bool noCalib = 0){
    ...
    for (int r = 0; r < nRow; r++){
      for (int c = 0; c < nCol; c++){
        for (int m = 0; m < nMod; m++){
          ...
          if(ithSpectra==spectra.end()){
            skipped++;
            std::cout << "WARNING: PlotCorr2D2ModLayer skipping cell ID: " << tempCellID << "\t row " << r << "\t column " << c << "\t layer " << layer << "\t module " << m << std::endl;
            pads[p]->Clear();
            pads[p]->Draw();
            if (p ==15 ){
  ...
  void PlotTrending2ModLayer (TCanvas* canvas, TPad* pads[16], Double_t* topRCornerX,  Double_t* topRCornerY, Double_t* relSize8P, Int_t textSizePixel, 
                              ...
                              Double_t xPMin, Double_t xPMax, int layer, TString nameOutput, TString nameOutputSummary, RunInfo currRunInfo, Int_t  detailedPlot = 1){
  ...
  void PlotRunOverlayProfile2ModLayer (TCanvas* canvas, TPad* pads[16], Double_t* topRCornerX,  Double_t* topRCornerY, Double_t* relSize8P, Int_t textSizePixel, 
                                      ...
                                      Double_t xPMin, Double_t xPMax, Double_t yPMin, Double_t yPMax,  int layer, TString nameOutput, TString nameOutputSummary, RunInfo currRunInfo, Int_t detailedPlot = 1){
