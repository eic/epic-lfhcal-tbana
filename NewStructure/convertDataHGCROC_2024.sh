...
#   build/Convert -d 0 -f -w -c $dataDir/Run$runNr.h2g -o $dataRaw/rawHGCROC_$runNr.root -m ../configs/mapping_HGCROC_PSTB_From_01092024.txt -r ../configs/DataTakingDB_202409_HGCROC.csv
# done
...
runs='007'
for runNr in $runs; do 
  build/Convert -d 0 -f -w -c $dataDir/Run$runNr.h2g -o $dataRaw/rawHGCROC_$runNr.root -m ../configs/mapping_HGCROC_Cosmics_20250606.txt -r ../configs/DataTakingDB_ORNL_HGCROC.txt
done
